 ...
 */
final class Version20180801125503 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE lessons (id INT AUTO_INCREMENT NOT NULL, idcategories_id INT NOT NULL, name VARCHAR(75) NOT NULL, lessons VARCHAR(45) NOT NULL, INDEX IDX_3F4218D9DB88036C (idcategories_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
